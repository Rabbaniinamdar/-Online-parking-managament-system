...
<head>
<title>feed</title>
<body background="images/car (8).jpg">

  <table  border="2"  cellpadding="2" cellspacing="0" bgcolor="skyblue" width="40%">
      <tr><td><center><font size="+5" color="GREEN">FeedBackInfo</center></td>
      </tr>
...
<table bordercolor="black" border="5"  bgcolor="lightyellow"  cellpadding="0"
    ...
    <TR>
        <TD><font color="green"></b><center>slno</center></td>
        <td><font color="green"></b><center>customername</center></td>
        <td><font color="green"></b><center>cnum</center></td>
        <TD><font color="green"></b><center>rating</center></td>
