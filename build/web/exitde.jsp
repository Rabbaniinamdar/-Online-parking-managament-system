...
<head>
<title>car</title>
<body background="images/exit.jpg">

  <table  border="2"  cellpadding="2" cellspacing="0" bgcolor="skyblue" width="40%">
      <tr><td><center><font size="+5" color="GREEN">
      Parking Exit</center></td>
      </tr>
...
String QueryString = "SELECT * from  carexi";
...
<table bordercolor="black" border="5"  bgcolor="lightyellow"  cellpadding="0"
    ...
    <TR>
        ...
        <td><font  color="green"></b><center>Description</center></td>
        <td><font  color="green"></b><center>Delete Parking</center></td>
...
<td><center><%=rs.getString(2)%></center>
 <td> <center>  <%=rs.getString(3)%></center>
     ...
     <td></b><center><%=rs.getString(5)%></center>
      ...
      <td>
              <center>  <a href="d1.jsp">Delete Parking</a></center>
            </td>
</tr>
